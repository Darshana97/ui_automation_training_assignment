...
public class LoginPage extends PageBase {
    ...
    private static By usernameText = By.id("uname");
    private static By passwordText = By.id("pwd");
    ...
    public static void setUsernamePassword(String uname,String pwd){
        getDriver().findElement(usernameText).sendKeys(uname);
        getDriver().findElement(passwordText).sendKeys((pwd));
    }
